...
public class EnquiryAction extends BaseAction{
	 ...
	 * Personal Details
	 */
	List<String> title; String theTitle; 	//
	List<String> gender; String theGender;	//
	List<String> culturalBackground; String theCulturalBackground; //
	Date birthDate;
	String firstName;
	String otherName;
	String lastName;
	...
	public List<String> getCulturalBackground() {
		return culturalBackground;
	}

	public void setCulturalBackground(List<String> culturalBackground) {
	...
	public void setAccomodation(List<String> accomodation) {
