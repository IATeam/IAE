...
<body>
	...
	<s:iterator value="attendees">
		<form method="post" action="AttendanceRemove.action">
			<input type="hidden" name="personId"
				...
				name="eventId" value='<s:property value="[1].id" />'> <input
				type="submit" value=- '-' title=Remove />
		</form>
	...
	<s:if test="nonAttendees.isEmpty()">
		<em>There is no one left to add</em>
		<br />
	</s:if>
